...
\book { 
    ...
    \header {
        title       = \markup {\larger "SILENT SORROW IN EMPTY BOATS"}
	    subtitle    = ""
    ...
    \score {
        <<
		    \new Staff = "Guitars" \with { midiInstrument = #"cello" fontSize = #-1 \override StaffSymbol #'staff-space = #(magstep -2) }
	        <<
		        \set Staff.instrumentName = "Guitars"
	            \guitars
            >>
